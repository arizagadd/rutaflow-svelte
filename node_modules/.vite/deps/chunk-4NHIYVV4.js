...
// node_modules/@ionic/core/dist/esm-es5/ionic-global-778b7863.js
var Config = function() {
  function i() {
...
// node_modules/@ionic/core/dist/esm-es5/hardware-back-button-f42b9c80.js
...
// node_modules/@ionic/core/dist/esm-es5/index-48209844.js
...
var createMenuController = function() {
        ...
        switch (o2.label) {
          ...
          case 1:
            ...
            if (n2 === "start" || n2 === "end") {
              ...
              if (i2.length >= 1) {
                if (i2.length > 1 && e2) {
                  printIonWarning('menuController queried for a menu on the "'.concat(n2, '" side, but ').concat(i2.length, " menus were found. The first menu reference will be used. If this is not the behavior you want then pass the ID of the menu instead of its side."), i2.map(function(n3) {
                    return n3.el;
                  }));
                }
                return [2, i2[0].el];
  ...
  return { registerAnimation: m, get: c, getMenus: v, getOpen: f, isEnabled: s, swipeGesture: o, isAnimating: d, isOpen: u, enable: a, toggle: i, close: t, open: e, _getOpenSync: w, _createAnimation: p, _register: _, _unregister: l, _setOpen: h };
};
var menuController = createMenuController();

// node_modules/@ionic/core/dist/esm-es5/overlays-33ae3ea0.js
...
@ionic/core/dist/esm-es5/ionic-global-778b7863.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
...
@ionic/core/dist/esm-es5/hardware-back-button-f42b9c80.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
...
@ionic/core/dist/esm-es5/index-48209844.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)

@ionic/core/dist/esm-es5/framework-delegate-fed7fe7c.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)

@ionic/core/dist/esm-es5/overlays-33ae3ea0.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
...
@ionic/core/dist/esm-es5/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4NHIYVV4.js.map
