<script lang="ts">
    ...
    function loadRoute(routeId) {
        ...
        fetch('https://rutaflow-app-development.up.railway.app/api/admin/report/seguimiento_list.php', {
                method: 'POST',
                body: requestData,
                })
    ...
    async function changeDeliveryStatus(deliveryId, status, comments) {
        ...
        return await fetch(`https://rutaflow-app-development.up.railway.app/admin/delivery/driver_status_change.php?id_delivery=${deliveryId}&status=${status}&comments=${comments}`)
                .then(response => response.json())
                .then(data => {
