...
function changeRouteStatus(id_route, status) {
  ...
  fetch("https://rutaflow-app-production.up.railway.app/api/admin/route/change_status.php", { method: "POST", body: requestData }).then((response) => response.json()).then((data) => {
  }).catch((error) => {
...
//# sourceMappingURL=_page.svelte-69PyjGOk.js.map
